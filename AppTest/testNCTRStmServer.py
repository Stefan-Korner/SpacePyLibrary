...
class ModelTask(UTIL.TASK.ProcessingTask):
  ...
  def frame1Cmd(self, argv):
    ...
    global s_tmSender
    frame = UnitTest.testData.TM_FRAME_01
    tmDu = GRND.NCTRSDU.TMdataUnit()
    tmDu.setFrame(frame)
    tmDu.spacecraftId = UnitTest.testData.NCTRS_TM_FRAME_01_spacecraftId
    tmDu.dataStreamType = UnitTest.testData.NCTRS_TM_FRAME_01_dataStreamType
    tmDu.virtualChannelId = UnitTest.testData.NCTRS_TM_FRAME_01_virtualChannelId
    tmDu.routeId = UnitTest.testData.NCTRS_TM_FRAME_01_routeId
    tmDu.earthReceptionTime = UnitTest.testData.NCTRS_TM_FRAME_01_earthReceptionTime
    tmDu.sequenceFlag = UnitTest.testData.NCTRS_TM_FRAME_01_sequenceFlag
    tmDu.qualityFlag = UnitTest.testData.NCTRS_TM_FRAME_01_qualityFlag
    print("tmDu =", tmDu)
